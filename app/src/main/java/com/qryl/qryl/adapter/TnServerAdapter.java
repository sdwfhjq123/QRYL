...
public class TnServerAdapter extends RecyclerView.Adapter<TnServerAdapter.ViewHolder> {

    private List<String> stringList = new ArrayList<>();

    public TnServerAdapter(List<String> list) {
        stringList = list;
    }
    ...
    @Override
    public TnServerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(TnServerAdapter.ViewHolder holder, int position) {
        //修改内容
        String s = stringList.get(position);
